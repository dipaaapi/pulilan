...
Date Submitted: <?php echo $sm['memo_date']; ?> <br>Status: <?php echo $sm['memo_status']; ?>
<textarea disabled><?php echo $sm['project_description']; ?></textarea>
<img src="achievment/temp/<?php echo $sm['picture']; ?>" width="300px" height="300px;">
