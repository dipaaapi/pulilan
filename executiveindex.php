        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="text-center">
                                <div style="text-transform: uppercase; padding: 5px;"><strong><?php echo $_SESSION ['username']; ?></strong></div>
                            </div>
                        </div>
                    ...
                    <!-- second-level-items -->
                    <li>
                        <a href="executiveindex.php"><i class="fa fa-user fa-fw"></i>Profile</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i>Resolution<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                           
                            <li>
                                <a href="addofficials.php">Add Resolution</a>
                            </li>
                             <li>
                                <a href="addnewresident.php">View Resolution</a>
                            </li>
                            
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-cogs fa-fw"></i>Notice<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                           
                            <li>
                                <a href="executiveviewmemo.php">View Memo</a>
                            </li>
...
if($type !=""){
    ...
    ?>
     <h3><?php echo $brgy; ?></h3>
                        ...
                        <label>Subject
                        <input type="text" disabled value="<?php echo $h['subject']; ?>" class="form-control">
                        </label>
                            <br>
                        <label>Receiver
                        <input type="text" disabled value="<?php echo $h['brgy_location']; ?>" class="form-control">
                        </label>
                        <br>
                        <label>Message
                        <textarea class="form-control" style="width: 500px;" disabled><?php echo $h['message']; ?></textarea>
                        </label>
