...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <!--start of query-->
                <?php
                $show_record="SELECT * FROM mainuser_acc WHERE accounttype='resident'AND visibility=0";
         ...
         { 
             ...
             ?>
              ...
              <td>
               <a type="button" href="delete_resacc.php?user_id=<?php echo $result['user_id']; ?>" class="btn btn-outline btn-danger fa fa-times"></a>
             </td>
            <tr>
        <?php
}
