...
<?php include('../pulilan/adminnav.php'); ?>
           ...
           <title>Community Based Barangay Answer</title>
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Resident Answer</h1>
                </div>
                 <!-- end  page header -->
                  <script> 
    function printpage() {
    ...
    <thead>
        <tr class="table-bordered">  
            ...
            <?php 
             ...
             $results = mysqli_query($connection, "SELECT * FROM resident_q");
        ...
        <tr>
            ...
            <td>
                <a href="viewresidentanswer.php?question_id=<?php echo $row['question_id'];?>" class="btn btn-outline btn-info fa fa-profile">  View Brgy Answer</a>
            </td>
