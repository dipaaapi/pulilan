  ...
  <table class="table table-responsive table-bordered">
    <thead>
        <tr>  
            ...
            <th>Position</th>
            <th>Brgy. Location</th>
            <th class="warning">Answer Brgy. Questionnaire</th>
    ...
    <tbody align="center">
            <?php 
             ...
             $results = mysqli_query($connection, "SELECT * FROM mainuser_acc where brgy_location = '$lol' AND type = 'official' and username = '$username'" );
        ...
        <tr>
            ...
            <td>
                <a href="brgy_q.php?user_id=<?php echo $row['user_id'];?>" class="btn btn-outline btn-info fa fa-pencil"></a>
            </td>
        </tr>
    </tbody>
