...
<body>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">Update Resident Details</a>
                            </li>
                        </ul>
        ...
        <div id="page-wrapper">
                ...
                <!--End Page Header -->
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" id="search" placeholder="search niguhh" class="form-control">
                         </div>
                        <div id="here"></div>
                        </div>
                        <script> 
            ...
            <!--start of query-->
                <?php
                $show_record="SELECT * FROM user_acc WHERE accounttype='resident'";
  ...
  <td><a href="updateresidentregistration.php?ID=<?php echo $result['ID'];?>">edit</a></td>
  <td><a href="delete_residentregistration.php?ID=<?php echo $result['ID'];?>">delete</a></td>
