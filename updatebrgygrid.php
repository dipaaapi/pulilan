                  ...
                  <fieldset>
                    <legend><b>Barangay Official's Information</b></legend>
                      ...
                      <div class="form-group col-md-6">
                       ...
                       <div class="form-group col-md-6">
                       <input  id="" type="input" name="brgy_location" class="form-control float-end"  placeholder="Enter Contact Number" value="<?php echo $h['brgy_location'], $brgy_location;?>" required>   
                      </div>
